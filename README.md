...
## Status
**PRIVATE PREPARATION ONLY — NOT RELEASE READY**
...
## Evidence hierarchy
1. Primary simulation: final 8-scenario × 1000-replicate production evidence.
2. Exploratory oracle sensitivity: post-production sensitivity only; must never overwrite or replace primary results.
3. Primary real-data application: frozen 365-day M8–M11 analysis.
4. Real-data sensitivities: 730-day horizon, 0.5–99.5% truncation, and untruncated analyses.
...
simulation tables, and generates Figures 1–2. If verified Stage 56 output files are present,
...
Tables S4–S6 can be generated without manual transcription.
